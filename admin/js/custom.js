  ...
  if ("undefined" != typeof $.fn.fullCalendar) {
    ...
    var e,
      ...
      g = $("#calendar").fullCalendar({
        ...
        events: [
          {
            title: "Appointment with Mr.X",
            start: new Date(2019, 10, 22, 19),
            end: new Date(2019, 10, 22, 22)
          },
          {
            title: "Promotion event",
            start: new Date(2019, 10, 13, 19),
            end: new Date(2019, 10, 13, 22)
          },
          {
            title: "Make deal with suppiler",
            start: new Date(2019, 10, 7, 19),
            end: new Date(2019, 10, 7, 22)
          },
          {
            title: "Trip to Tokyo",
            start: new Date(2019, 10, 26, 19),
            end: new Date(2019, 10, 28, 22)
          },
          {
            title: "Rountine meeting",
            start: '10:00',
            end: '12:00',
            dow : [1]
          },
